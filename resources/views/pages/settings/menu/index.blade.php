...
<div class="modal modal-blur fade" id="modal-form-menu" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('core.admin.menu.save') }}" method="POST" class="ajax_form" autocomplete="off">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="menu_name" name="name" type="text" class="form-control" placeholder="Enter name">
                    </div>
                    <div class="mb-3">
