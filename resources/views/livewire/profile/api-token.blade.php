                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-danger" data-bs-toggle="modal"
                                            data-bs-target="#modal-delete-token-{{ $token->id }}">Delete</button>
                                        <div class="modal fade" id="modal-delete-token-{{ $token->id }}"
                                            tabindex="-1" style="display: none;" aria-hidden="true" wire:ignore.self>
                                            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center py-4">
                                                        ...
                                                        <h3>Are you sure?</h3>
                                                        <div class="text-muted">Do you really want to remove token?
