...
use OpenJournalTeam\Core\Classes\Filepond;
...
class FilepondController extends BaseController
{
    ...
    public function __construct(Filepond $filepond)
    {
        ...
        $this->path = config('filepond.temporary_files_path', 'filepond');
        $this->disk = config('filepond.temporary_files_disk', 'local');
    }
    ...
    public function upload(Request $request)
    {
        ...
        if (!($newFile = $file->storeAs($this->path . DIRECTORY_SEPARATOR . Str::random(), $file->getClientOriginalName(), $this->disk))) {
    ...
    private function handleChunkInitialization()
    {
        ...
        $fileLocation = $this->path . DIRECTORY_SEPARATOR . $randomId;

        $fileCreated = Storage::disk($this->disk)
            ->put($fileLocation, '');
    ...
    public function chunk(Request $request)
    {
        ...
        $this->persistFileIfDone($this->disk, $basePath, $length, $finalFilePath);
    ...
    public function load(Request $request, Media $media)
    {
